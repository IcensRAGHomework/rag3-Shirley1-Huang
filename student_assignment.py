...
def generate_hw03(question, store_name, new_store_name, city, store_type):
    ...
    names = list( metadata['new_store_name'] if metadata['new_store_name']!=null else metadata['name'] for metadata, distance in zip(result['metadatas'][0], result['distances'][0]) if distance < 0.2) 
    #print(names)
